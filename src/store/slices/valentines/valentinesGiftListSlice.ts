	...
	extraReducers: (builder) => {
		builder
			...
			.addCase(fetchValentinesGifts.rejected, (state, action) => {
				state.loading = false;
				state.error =
					action.error.message || "Failed to fetch Valentine's gifts";
			})
			...
			.addCase(updateValentinesGift.rejected, (state, action) => {
				state.loading = false;
				state.error =
					action.error.message || "Failed to update Valentine's gift";
			})
			...
			.addCase(deleteValentinesGift.rejected, (state, action) => {
				state.loading = false;
				state.error =
					action.error.message || "Failed to delete Valentine's gift";
			})
			...
			.addCase(toggleValentinesGiftCompletion.rejected, (state, action) => {
				...
				state.error =
					...
					"Failed to toggle Valentine's gift completion";
			});
	},
});
