  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(fetchValentinesTasks.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || "Failed to fetch Valentine's tasks";
      })
      ...
      .addCase(updateValentinesTask.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || "Failed to update Valentine's task";
      })
      ...
      .addCase(deleteValentinesTask.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || "Failed to delete Valentine's task";
      })
      ...
      .addCase(toggleValentinesTaskCompletion.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.error.message || "Failed to toggle Valentine's task completion";
      });
  },
});
