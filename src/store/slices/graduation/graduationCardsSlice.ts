  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(fetchGraduationCards.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to fetch graduation cards';
      })
      ...
      .addCase(updateGraduationCard.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to update graduation card';
      })
      ...
      .addCase(deleteGraduationCard.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to delete graduation card';
      });
  },
});
