  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(fetchGraduationTasks.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to fetch graduation tasks';
      })
      ...
      .addCase(updateGraduationTask.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to update graduation task';
      })
      ...
      .addCase(deleteGraduationTask.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to delete graduation task';
      });
  },
});
