	...
	extraReducers: (builder) => {
		builder
			...
			.addCase(fetchGraduationGifts.rejected, (state, action) => {
				state.loading = false;
				state.error =
					action.error.message || "Failed to fetch graduation gifts";
			})
			...
			.addCase(updateGraduationGift.rejected, (state, action) => {
				state.loading = false;
				state.error =
					action.error.message || "Failed to update graduation gift";
			})
			...
			.addCase(deleteGraduationGift.rejected, (state, action) => {
				state.loading = false;
				state.error =
					action.error.message || "Failed to delete graduation gift";
			});
	},
});
