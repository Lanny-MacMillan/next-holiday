  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(fetchAnniversaryTasks.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to fetch anniversary tasks';
      })
      ...
      .addCase(updateAnniversaryTask.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to update anniversary task';
      })
      ...
      .addCase(deleteAnniversaryTask.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to delete anniversary task';
      })
      ...
      .addCase(toggleAnniversaryTaskCompletion.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.error.message || 'Failed to toggle anniversary task completion';
      });
  },
});
