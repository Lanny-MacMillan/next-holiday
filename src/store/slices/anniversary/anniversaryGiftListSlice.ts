  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(fetchAnniversaryGifts.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to fetch anniversary gifts';
      })
      ...
      .addCase(updateAnniversaryGift.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to update anniversary gift';
      })
      ...
      .addCase(deleteAnniversaryGift.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to delete anniversary gift';
      })
      ...
      .addCase(toggleAnniversaryGiftCompletion.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.error.message || 'Failed to toggle anniversary gift completion';
      });
  },
});
