				...
				resolve([
					{
						id: "1",
						name: "Hostess Gift",
						description: "Gift for the Thanksgiving host",
						price: 25.0,
						category: "Host Gifts",
						isCompleted: false,
					...
					},
					{
						id: "3",
						name: "Dessert",
						description: "Pie or dessert to bring",
						price: 12.0,
						category: "Food",
						isCompleted: false,
						createdAt: new Date().toISOString(),
...
const thanksgivingGiftListSlice = createSlice({
	...
	reducers: {
		setSelectedGift: (
			state,
			action: PayloadAction<ThanksgivingGift | null>
		) => {
...
export const { setSelectedGift, clearError } =
	thanksgivingGiftListSlice.actions;
