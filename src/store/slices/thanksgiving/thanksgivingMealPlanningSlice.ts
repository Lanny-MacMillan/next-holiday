        ...
        resolve([
          {
            ...
            description: 'Traditional Thanksgiving turkey with herbs and butter',
            cookTime: '4 hours',
            prepTime: '30 minutes',
            servings: 12,
            difficulty: 'medium',
...
const thanksgivingMealPlanningSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(toggleThanksgivingRecipeCompletion.fulfilled, (state, action) => {
        state.loading = false;
      ...
      .addCase(toggleThanksgivingRecipeCompletion.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message || 'Failed to toggle recipe completion';
      });
  },
});
