          ...
          api.util.updateQueryData(
            ...
            draft => {
              if (draft) {
                ...
                console.error('No draft found - query data not available');
              }
            },
          ),
        );
          ...
          api.util.updateQueryData('getEvents', { holidayId, auth0User }, draft => {
            if (draft) {
              ...
              if (index !== -1) {
                ...
                console.error('Event not found in cache');
              }
            } else {
              console.error('No draft found - query data not available');
            }
            ...
            draft => {
              if (draft) {
                ...
                if (index !== -1) {
                  ...
                  console.error('Guest not found in cache');
                }
              } else {
                console.error('No draft found - query data not available');
              }
