...
export default function BirthdayTasksPage() {
  ...
  const themeColor = '#f59e0b'; // Amber for Birthday
  ...
  return (
    <div className="min-h-screen birthday-gradient flex flex-col items-center p-4 sm:p-8 font-sans">
      ...
      <main className="w-full max-w-4xl flex flex-col gap-6">
        <AddButton title="Task" onClick={openForm} color="yellow" />
