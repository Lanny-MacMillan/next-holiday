...
export default function GiftListPage() {
	...
	useEffect(() => {
		console.log("Contacts in Mother's Day gift list:", contacts);
	...
	// Debug: Log gift data
	useEffect(() => {
		console.log("Mother's Day gift list - holidayId:", holidayId);
		console.log("Mother's Day gift list - holidayData:", holidayData);
		console.log("Mother's Day gift list - homeInitialized:", homeInitialized);
		console.log("Mother's Day gift list - displayGifts:", displayGifts);
