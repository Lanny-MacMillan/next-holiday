...
export default function BabyShowerTasksPage() {
  ...
  const themeColor = '#0891b2'; // Cyan for Baby Shower
  ...
  return (
    <div className="min-h-screen baby-shower-gradient flex flex-col items-center p-4 sm:p-8 font-sans">
      ...
      <main className="w-full max-w-4xl flex flex-col gap-6">
        <AddButton title="Task" onClick={openForm} color="cyan" />
