		...
		<div className="min-h-screen halloween-gradient flex flex-col items-center p-4 sm:p-8 font-sans">
			<header className="w-full max-w-2xl py-6 flex flex-col items-center relative">
				...
				<p className="text-center text-gray-600 dark:text-gray-400">
					Stay on top of your Halloween decorations!
				</p>
			</header>
					...
					<div className="card card-tasks rounded shadow">
						{incompleteTasks.length === 0 ? (
							...
							<ul className="divide-y divide-gray-200 dark:divide-gray-700">
								{incompleteTasks.map((task: HalloweenTask) => (
									<li
										key={task.id}
										className="flex items-center px-4 py-3 cursor-pointer hover:bg-orange-50 dark:hover:bg-orange-900/20"
				...
				<div>
					...
					<div className="card card-tasks rounded shadow">
						{completedTasks.length === 0 ? (
							...
							<ul className="divide-y divide-gray-200 dark:divide-gray-700">
								{completedTasks.map((task: HalloweenTask) => (
									<li
										key={task.id}
										className="flex items-center px-4 py-3 cursor-pointer hover:bg-orange-50 dark:hover:bg-orange-900/20 opacity-60"
										onClick={() => handleToggleTask(task.id)}
									>
										<input
											type="checkbox"
					...
					<div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-sm w-full mx-4">
						...
						<div className="flex gap-2">
							...
							<button
								...
								className="bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 font-medium px-4 py-2 rounded-lg transition-colors hover:bg-gray-400 dark:hover:bg-gray-500"
							>
								Cancel
							</button>
						</div>
