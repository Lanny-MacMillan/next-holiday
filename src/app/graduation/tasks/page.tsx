...
export default function GraduationTasksPage() {
  ...
  const themeColor = '#8b5cf6'; // Purple for Graduation
  ...
  async function handleTaskToggle(taskId: string) {
    ...
    // RTK Query updateTask mutation handles Home Slice updates automatically
  ...
  const handleAddTask = async (formData: any) => {
    ...
    try {
      const taskData = {
        ...
        assigned_to: formData.assigned_to || undefined, // Snake case for API
        due_date: formData.dueDate || undefined, // Snake case for API
        category: 'Tasks',
        isCompleted: false,
      };

      // RTK Query createTask mutation handles Home Slice updates automatically
  ...
  const handleEditTask = async (formData: any) => {
    ...
    try {
      const taskData = {
        ...
        description: formData.description,
        priority: formData.priority,
        assigned_to: formData.assigned_to || null, // Snake case for API
        due_date: formData.dueDate || null, // Snake case for API
      };
  ...
  const handleDeleteTask = async () => {
    ...
    // RTK Query deleteTask mutation handles Home Slice updates automatically
  ...
  return (
    <div className="min-h-screen graduation-gradient flex flex-col items-center p-4 sm:p-8 font-sans">
      ...
      <main className="w-full max-w-4xl flex flex-col gap-6">
        <AddButton title="Task" onClick={openForm} color="purple" />
