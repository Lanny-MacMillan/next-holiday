    ...
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown Panel */}
          <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-16 sm:top-auto sm:mt-2 w-auto sm:w-96 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 max-h-96 overflow-hidden max-w-md sm:max-w-none mx-auto sm:mx-0">
            {/* Header */}
