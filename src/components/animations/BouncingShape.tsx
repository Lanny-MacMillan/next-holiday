...
import {
  generateRandomBouncingAnimation,
  cleanupOldAnimations,
} from '@/utils/randomAnimations';
...
const BouncingShape: React.FC<BouncingShapeProps> = ({
  ...
  const getShapeComponent = () => {
    ...
    if (holidayId && HolidayShapes[holidayId as keyof typeof HolidayShapes]) {
      return HolidayShapes[
        holidayId as keyof typeof HolidayShapes
      ] as unknown as React.ComponentType<HolidayShapeProps>;
    }
    ...
    if (HolidayShapes[normalizedHolidayId as keyof typeof HolidayShapes]) {
      return HolidayShapes[
        normalizedHolidayId as keyof typeof HolidayShapes
      ] as unknown as React.ComponentType<HolidayShapeProps>;
    }
