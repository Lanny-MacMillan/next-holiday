...
export function useResolutionsMutations() {
  ...
  const [createResolutions, createResolutionsState] = useCreateResolutionsMutation();
  const [updateResolutions, updateResolutionsState] = useUpdateResolutionsMutation();
  const [editResolutions, editResolutionsState] = useEditResolutionsMutation();
  const [deleteResolutions, deleteResolutionsState] = useDeleteResolutionsMutation();
