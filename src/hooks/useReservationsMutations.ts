...
export function useReservationsMutations() {
	...
	const [createReservations, createReservationsState] = useCreateReservationsMutation();
	const [updateReservations, updateReservationsState] = useUpdateReservationsMutation();
	const [editReservations, editReservationsState] = useEditReservationsMutation();
	const [deleteReservations, deleteReservationsState] = useDeleteReservationsMutation();
