...
export function IconValentines({ title = "Valentine's Day", ...props }: IconProps) {
  return (
    <IconBase title={title} {...props}>
...
export function IconThanksgiving({ title = 'Thanksgiving', ...props }: IconProps) {
  return (
    <IconBase title={title} {...props}>
...
export function IconMothersDay({ title = "Mother's Day", ...props }: IconProps) {
  return (
    <IconBase title={title} {...props}>
      <circle cx="12" cy="12" r="2" />
...
export function IconFathersDay({ title = "Father's Day", ...props }: IconProps) {
  return (
    <IconBase title={title} {...props}>
...
export function IconAnniversary({ title = 'Anniversary', ...props }: IconProps) {
  return (
    <IconBase title={title} {...props}>
...
export function IconFourthOfJuly({ title = 'Fourth of July', ...props }: IconProps) {
  return (
    <IconBase title={title} {...props}>
