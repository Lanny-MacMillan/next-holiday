...
async function testUserPreferencesAPI() {
  ...
  console.log('1. Testing get user preferences (GET /api/users/me/preferences)...');
  try {
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log(`   - Display Mode: ${result.displayMode} (should be 'list')`);
      console.log(
      ...
      console.log(`   - Reduced Motion: ${result.reducedMotion} (should be true)`);
      console.log(`   - High Contrast: ${result.highContrast} (should be true)`);
    } else {
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log(`   - Display Mode: ${result.displayMode} (should be 'grid')`);
      console.log(`   - Show Countdown: ${result.showCountdown} (should be false)`);
      console.log(
